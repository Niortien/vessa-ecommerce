...
import { login } from "@/service-anvogue/authentification/authentification.action";
...
export default function LoginForm() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<ConnexionClientSchema>({
    resolver: zodResolver(connexionClientSchema),
  });

  const togglePasswordVisibility = () => setShowPassword(!showPassword);

//   const handleConnexion: SubmitHandler<ConnexionClientSchema> = async (data) => {
...
//      router.push("/"); // Redirection vers le tableau de bord
//    }
// };
...
const handleConnexion: SubmitHandler<ConnexionClientSchema> = async (data) => {
  ...
  if (res?.error) {
    ...
    window.localStorage.setItem("emai", data.email); // Stockage du token
    toast.success("Connexion réussie !");
    router.push("/otp"); // Redirection après succès
  }
};
            ...
            <div className="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <form onSubmit={handleSubmit(handleConnexion)} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg pr-12 focus:ring-2 focus:ring-orange-500 focus:outline-none ${
                ...
                <p className="text-center text-gray-600 text-sm mt-4 flex items-center justify-center">
                  ...
                  className="w-full bg-red-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 transition-all font-medium shadow-lg"
                >
                  Inscrivez vous ici
                </button>
                  </Link>  
