...
const faqItems: FaqItem[] = [
  {
    id: '1',
    question: 'what is Vessa',
    answer:
      'vessa is a free  e-commerce application built with Next.js, Tailwind CSS, and TypeScript. It provides a set of reusable components and templates to help you quickly build modern web applications.',
    category: 'general',
  },
  {
    id: '2',
